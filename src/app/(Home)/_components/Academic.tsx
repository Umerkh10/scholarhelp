    ...
    <div className='mx-auto max-w-screen-xl mt-10'>
        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-10 mx-auto'>
            ...
            <div className='group  p-4'>
                ...
                <div className=' flex-col items-center group-hover:border-[5px] 
                ...
                group-hover:border-yellow-400  group-hover:bg-indigo-700 group-hover:scale-105 group-hover:shadow-xl transition ease-in delay-200 duration-200 bg-indigo-400  md:h-[370px] w-full rounded-lg px-4 py-5 '>
                    ...
                    <div className='flex flex-col mt-4'>
                        ...
                        <div className=' text-zinc-200 font-medium '>Want to Ace your online exams without taking any stress, Scholarly Help tutors are at your service with Guaranteed best results in your online exams.</div>
                    </div>
                </div>
                </div>
            ...
            <div className=' group p-4'>
                ...
                group-hover:border-yellow-400  group-hover:bg-indigo-700 group-hover:scale-105 group-hover:shadow-xl transition ease-in delay-200 duration-200 bg-indigo-400  md:h-[370px] w-full rounded-lg px-4 py-5 '>
                    ...
                    <div className='flex flex-col mt-4'>
                        ...
                        <div className=' text-zinc-200 font-medium '>Online homeworks can be very tricky and mind-exhausting at all times, but with Scholarly Help Reliable & Affordable service of online homework assistance everything becomes smooth and easy.</div>
                    </div>
                </div>
                </div>
                </div>
                ...
                group-hover:border-yellow-400  group-hover:bg-indigo-700 group-hover:scale-105 group-hover:shadow-xl transition ease-in delay-200 duration-200 bg-indigo-400  md:h-[370px] w-full rounded-lg px-4 py-5 '>
                    ...
                    <div className='flex flex-col mt-4'>
                        ...
                        <div className=' text-zinc-200 font-medium '>Are you finding it difficult to complete your assignment questions correctly and on time? Worry not, Scholarly Help offers 24/7 homework aid with reliable client support at your service.</div>
                    </div>
                </div>
                </div>
