                    ...
                    <div className="hidden lg:ml-6 lg:flex lg:items-center">
                        <div className="flex space-x-4">
                            <Button  variant="ghost" asChild>
                                <Link className='hover:text-violet-600 hover:font-semibold' href="/">Home</Link>
                            </Button>
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="inline-flex items-center hover:text-violet-600 hover:font-semibold">
                                        Services
                            ...
                            <Button variant="ghost" asChild>
                                <Link className='hover:text-violet-600 hover:font-semibold' href="/contact">Contact Us</Link>
                            </Button>
                            <Button variant="ghost" asChild>
                                <Link className='hover:text-violet-600 hover:font-semibold' href="/about">About Us</Link>
                            </Button>
                            <Button variant="ghost" asChild>
                                <Link className='hover:text-violet-600 hover:font-semibold' href="/Reviews">Reviews</Link>
                            </Button>
                            <Button variant="ghost" asChild>
                                <Link className='hover:text-violet-600 hover:font-semibold' href="/Order">Order Now</Link>
                            </Button>
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="inline-flex items-center hover:text-violet-600 hover:font-semibold">
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        <Button variant="ghost" className="block w-full text-left" onClick={() => setIsMobileMenuOpen(false)}>
