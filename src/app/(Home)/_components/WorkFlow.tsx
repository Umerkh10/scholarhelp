      ...
      <div className='text-center text-3xl md:text-5xl font-extrabold dark:text-zinc-100 text-violet-950'>Workflow Process We Follow</div>
        ...
        <TabsContent value="1">
          <div className='grid lg:grid-cols-2 grid-cols-1 p-5'>
            ...
            <div   className=''>
              ...
              <div className='mt-2 md:mt-5 text-xl font-medium dark:text-zinc-100 text-indigo-900'>You can submit your order details through our online form, WhatsApp, live chat, or email.</div>
        ...
        <TabsContent value="2">
           <div className='grid lg:grid-cols-2 grid-cols-1 p-5'>
            ...
            <div    className=''>
              ...
              <div className='mt-2 md:mt-5 text-xl font-medium dark:text-zinc-100 text-indigo-900'>Make an advance payment to confirm and start your order.</div>
              <div className='flex justify-start items-center group mt-5'>
                <button className='group-hover:text-black transition ease-in delay-200 duration-200 border-[2px] border-yellow-600 group-hover:scale-105 group-hover:shadow-xl group-hover:opacity-90 bg-yellow-400  px-4 py-4 rounded-lg font-bold'>Place Your Order</button>
              </div>
            </div>
        ...
        <TabsContent value="3">
            ...
            <div    className=''>
              ...
              <div className='mt-2 md:mt-5 text-xl font-medium dark:text-zinc-100 text-indigo-900'>
