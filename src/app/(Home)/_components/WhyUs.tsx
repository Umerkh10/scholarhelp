...
const slideData = [
  {
    ...
    description: 'We offer solutions to help you manage your online class tasks efficiently. We respect your deadlines and ensure your work is delivered on time. Say goodbye to concerns about missing deadlines and let Taking My Classes Online Help handle everything for you.',
    image: '/imgs/result-1.png',
  },
  {
    id: 2,
    title: 'Elite Subject Specialists',
    description: 'Taking My Classes Online Help comprises multiple teams of native experts with deep knowledge in their respective subject areas. They possess a strong command of the English language, allowing them to create error-free high-quality content.',
  ...
  },
  {
    ...
    description: 'Taking My Classes Online Help delivers content that is completely free from plagiarism. Our team specializes in thesis writing, ensuring you can trust their expertise to create authentic, plagiarism-free work for you.',
  ...
  },
  {
    ...
    description: 'Taking My Classes Online Help is committed to protecting your privacy. We only request an email and contact number, which are optional. Rest assured, any information provided is kept confidential and is only accessible to authorized personnel.',
    image: '/imgs/confidential-folder.png',
  },
  {
    id: 8,
    title: 'Flawless Grammar',
    description: 'With Taking My Classes Online Help, you can be confident in flawless grammar and punctuation. Additionally, they verify grammatical accuracy using online tools for complete assurance.',
    ...
    <div className='relative scale-95 group-hover:scale-100 group-hover:border-yellow-400 border-[5px] group-hover:bg-indigo-900 transition ease-in duration-200 delay-100 border-indigo-600 lg:h-[350px] w-full rounded-xl p-4 overflow-hidden'>
      ...
      <div className='relative z-10'>
        <div className='flex justify-between'>
          ...
          <div className='font-extrabold text-7xl opacity-10 group-hover:opacity-100 transition ease-in duration-200 delay-100 group-hover:text-yellow-500'>{index.toString().padStart(2, '0')}</div>
        </div>
