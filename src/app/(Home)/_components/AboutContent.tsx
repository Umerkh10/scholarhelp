  ...
  return (
    ...
    <div   className=''>
      <div className='flex justify-start items-center mt-5 lg:mt-20'>
        <h2 className='text-xl md:text-3xl font-bold dark:text-zinc-100 text-indigo-900 '>Take My Online Classes and Secure High Grades - Pay Someone to Take My Class</h2>
      </div>
      <p className='mt-2 md:mt-4 md:text-base text-sm font-medium dark:text-zinc-100 text-indigo-900'>
