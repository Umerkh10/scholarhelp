  ...
  return (
    ...
    <div   className=''>
      <div className='flex justify-start items-center mt-5 lg:mt-20'>
        <h2 className='text-xl md:text-3xl font-extrabold text-center dark:text-zinc-100 text-indigo-900 '>Take My Online Classes and Secure High Grades - Pay Someone to Take My Class</h2>
      </div>
