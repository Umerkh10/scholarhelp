...
<div className={`${theme === 'light' ? 'm-h-[500px] border-b-2 border-indigo-200 -z-10 h-full w-full bg-gradient-to-t from-indigo-200 via-purple-100 to-zinc-100' : ' -z-10 m-h-[500px] w-full [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] '}`}>
