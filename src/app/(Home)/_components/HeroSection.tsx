...
<div className={`${theme === 'light' ? 'border-b-2 border-indigo-200 -z-10 h-full w-full bg-gradient-to-t from-indigo-200 via-purple-100 to-zinc-100' : ' -z-10 h-full w-full [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]'}`}>
      <div className=' mx-auto max-w-screen-xl ' >
        <div className='py-20 px-5 md:py-28'>
          <div className='md:text-center dark:text-zinc-100 text-violet-950 text-xl sm:text-3xl font-extrabold '>Hire Expert</div>
          <div className='md:text-center dark:text-zinc-100 text-violet-950 text-3xl sm:text-5xl font-extrabold'>Academic Writers</div>
          <div className='md:text-center dark:text-zinc-100 text-violet-950 text-xl sm:text-3xl font-extrabold pt-2 '>To Elevate Your Grades!</div>
          <div className='max-w-screen-md mx-auto md:text-center  pt-4 font-medium dark:text-zinc-100 text-violet-950 sm:text-lg '>
          ...
          <div className='flex justify-center items-center border-[2px] border-zinc-400 bg-zinc-100
            ...
            <div className='flex justify-center items-center border-[2px] dark:bg-slate-200 bg-zinc-800
