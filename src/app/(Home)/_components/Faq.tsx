...
const Faq = () => {
    ...
    return (
        <div className='mx-auto max-w-screen-xl mt-10'>
            <h2 className='text-center text-2xl lg:text-4xl font-extrabold dark:text-zinc-100 text-indigo-950'>Frequently Asked Questions</h2>
            <h3 className='text-center text-xl lg:text-3xl font-bold dark:text-zinc-100 text-indigo-950'>The list of questions that are frequently asked by Our Clients</h3>
