...
function DynamicContent2() {
  return (
    ...
    <div className='p-5'>
        ...
        <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>Our packages have been adjusted to consider your financial burdens when pursuing ‘take my online classes’ or ‘Do My Classes for Me’. You can use our live support service to discuss the price or just write,<Link href={'/take-my-gre-exam'} className=' hover:text-blue-400 transition ease-in duration-150 delay-150'>‘How much is it to take the GRE?’ </Link> Within seconds, you will get a reply and the price information. Our prices are affordable and reasonable, making it accessible for clients to buy and utilize our classs services. Those students who are struggling financially, can have opportunities to utilize our online classes services. We also ensure maintaining quality while delivering cheap writing services.  </p>
