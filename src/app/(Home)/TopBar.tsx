  ...
  return (
    ...
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 grid-cols-1  items-center">
        ...
        <Button className=' border-0 border-r-2 border-gray-200 dark:border-slate-600 rounded-none' onClick={openChat} variant="outline" size="default">
          ...
          <Button className='border-0 border-r-2 border-gray-200 dark:border-slate-600 rounded-none' variant="outline" size="default">
          ...
          <Button className='border-0 border-r-2 bborder-gray-200 dark:border-slate-600 rounded-none' variant="outline" size="default">
            <MailIcon className="w-5 h-5 sm:mr-2" />
            <span className="hidden lg:inline">support@takingmyclassesonline.com</span>
          </Button>
          </Link>

          <Button className=' border-0 border-r-2 border-gray-200 dark:border-slate-600 rounded-none' variant="outline" size="default" asChild>
            <Link href="tel:19179331132">
