  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 mx-auto max-w-screen-xl py-10 '>
      <div className='py-20 px-5 md:pt-40'>
        <h1 className=' text-center leading-none lg:text-left dark:text-zinc-100 text-zinc-900 text-xl sm:text-[35px] font-extrabold '>How do I take the Gre Test At Cheap Price</h1>
        <h2 className='text-center py-1 lg:text-left dark:text-zinc-100 text-zinc-900 text-xl sm:text-2xl font-semibold'> Can I Pay Someone to take my GRE Home Test Online with Affordable Package</h2>
        ...
        <h3 className='text-center dark:text-zinc-100 text-zinc-900 md:text-base font-medium'>Online PhD Tutor for Support </h3>
        ...
        <h3 className='text-center dark:text-zinc-100 text-zinc-900 md:text-base font-medium'>Authentic Legit Service</h3>
        <div className='hidden lg:block w-[2px] h-20 bg-muted-foreground '></div>
        </div>
          <div className='flex items-center gap-1'>
