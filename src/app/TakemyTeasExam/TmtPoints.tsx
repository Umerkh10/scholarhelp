...
const slideData = [
    ...
    
    {
      ...
      description: `Our aim is to provide the best services at an affordable price. Actually, we promote equal rights so that every student gets the same treatment regardless of their financial condition. We prioritize your privacy regarding payment. `,
