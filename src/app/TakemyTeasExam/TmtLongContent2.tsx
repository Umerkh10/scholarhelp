    ...
    return (
        <>
            ...
            <div >
                ...
                <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>Our aim is to provide every student with valuable education which helps them in sorting out their stress and queries. This platform has many services including “take my HESI exam for me” and many more to help you to achieve better results.</p>
