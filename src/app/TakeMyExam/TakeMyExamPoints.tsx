...
function TakeMyExamPoints() {
  return (
    ...
    <h2 className='text-center text-xl md:text-[33px] font-extrabold dark:text-zinc-100 text-zinc-900'> Need an Affordable exam helper? Get Reliable support and Achieve Your Desired Benefits </h2>
    <h3 className='text-center text-lg py-2 md:text-3xl font-bold dark:text-zinc-100 text-zinc-900'>Take benefits of Online Exam help Across the USA</h3>
    <Swiper
      loop={true}
      spaceBetween={20}
