    ...
    <div data-aos='fade-up'>
        <div className='mx-auto max-w-screen-xl mt-10'>
            ...
            <div className='p-5'>
                ...
                <p className='font-medium text-muted-foreground md:text-base text-sm pt-4 '>Most of the students are unmotivated to participate in physical education regularly . While in this fast-paced world, there is a diverse range of options for learning. Well the most prominent is Online learning. Moreover, It not only helps to build learning concepts but also helps to develop more skills. However, Students also struggle to find the best assistance for their studies. In this case hiring some to give your exam will be a prominent solution to help you to achieve better results. Our experts not only help you to <Link href={'/toefl-exam-online'} className='hover:text-blue-400 transition ease-in duration-150 delay-150'> take the toefl test online</Link>  or any other exams and also assist you throughout your academic journey.</p>
    ...
    return (
        <>
            ...
            <div >
                ...
                <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>Our aim is to provide every student with valuable education which helps them in sorting out their stress and queries. This platform has many services including <Link href={'/hesi-exam'} className='hover:text-blue-400 transition ease-in duration-150 delay-150 '> “take my HESI exam for me”</Link>  and many more to help you to achieve better results.</p>
