    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-4 p-5 mt-5'>
        <div className=''>
            <div data-aos="flip-down" className="md:pt-6 pt-8 "  >
                ...
                <Link href={'/pay-someone-to-take-my-class'} className='hover:text-blue-400 transition ease-in duration-150 delay-150 font-bold'> paying someone to take my class</Link>  will definitely help you to increase chances for better marks. Our services will help you stay up to date with the world and also help in their exams so that you don’t have to ask for “how many times can you take the GMAT test?”.
                </p>
