  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 mx-auto max-w-screen-xl py-10 '>
      <div className='py-20 px-5 md:pt-40'>
        <h1 className=' text-center leading-none lg:text-left dark:text-zinc-100 text-zinc-900 text-xl sm:text-[35px] font-extrabold '>Should I Pay Someone To Take My HESI Exam For Me At An Affordable Price?</h1>
        <h2 className='text-center py-1 lg:text-left dark:text-zinc-100 text-zinc-900 text-xl sm:text-2xl font-semibold'>A Comprehensive Guide For HESI A2 Nursing Entrance Exam</h2>
