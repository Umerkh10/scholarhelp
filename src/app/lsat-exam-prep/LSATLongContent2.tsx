        ...
        <>
            <div className='mx-auto max-w-screen-xl mt-5'>
                <div className='p-5'>
                    ...
                    <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>The main reason why every student hire someone to take a test is for better marks, as grades often determine the direction of their future academic and career paths. We provide every help to our students to get them their desired marks so that they can get admission to their desired institute. </p>
    ...
    return (
        <>
            ...
            <div >
                ...
                <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>Our expert instructors are highly certified and experienced in various exam formats which not only help you in LSAT exam format but also access you every exam. They are highly qualified and experienced which is one of the reasons why every student is successful in their academic journey. Join us! And get benefits from our services throughout your academic career .Enroll to ”take my class for me online” and succeed with expert support. </p>

                <h3 className='font-extrabold text-lg md:text-3xl dark:text-zinc-100 text-indigo-950 mt-3'>
                Try Free Practice Of LSAT Exam</h3>
                <p className='font-medium text-muted-foreground md:text-base text-sm pt-4'>The engaging lecture is one of the main components of the lesson plan. Our expert schedules engaging lectures to make you motivated throughout the journey and also help you in preparing for every exam format. Including mock toefl exam online. We secure your data with us so that your data won’t get disclosed with any of the others. Get free practice for the LSAT exam with us.</p>
