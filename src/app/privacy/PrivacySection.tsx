...
function PrivacySection() {
  ...
  return (
    ...
    <div className='pt-10 text-center font-extrabold text-2xl lg:text-5xl' data-aos='flip-down'>Data Protection and Privacy</div>

    <div className='py-3 text-center font-medium md:text-lg text-sm max-w-screen-md mx-auto'data-aos='flip-up' >At {process.env.NEXT_PUBLIC_WEBSITE_NAME}, we prioritize the privacy and security of your personal information.
