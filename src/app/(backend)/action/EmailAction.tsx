...
async function sendEmailClient(data: any) {
  ...
  const clientMailOptions = {
    ...
    to: email,
    subject: `We Have Recieved Your Order - Complete Your Payment Now | ${process.env.NEXT_PUBLIC_WEBSITE_NAME}`,
    html: `
 <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f0f0f0; ">
    ...
    <div style="width:100%; height: 3px; background-color: #ffd17e; margin-bottom: 20px;"></div>
      ...
      <div style="text-align: center;">
        ...
        <a href="https://wa.me/3197005034911?text=Hi, I urgently need academic assistance. Could you help me submit my assignment before the deadline?" style="display: inline-block;color: #f0f0f0;  padding: 15px 30px; background-color: #15d704;  text-decoration: none; font-size: 16px; font-weight: bold; border-radius: 5px; margin: 10px 0; text-align: center; vertical-align: middle;">
          Whatsapp Now
        </a>
      </div>
