...
const slideData = [
    ...
    },
    {
      ...
      description: `Are you looking for online tutoring services to take my online classes and still not satisfied with the result? You’re in the right spot to hire our experts and let them help you to ace in your exams. However, We aim to provide our services at an affordable price to give every student the best result in their academics. `,
...
function PtePoints() {
  return (
    ...
    <h2 className='text-center text-xl md:text-[33px] font-extrabold dark:text-zinc-100 text-zinc-900'> Get The Desired Benefits Of Hiring From Takemyclassesonline </h2>
    <h3 className='text-center text-lg py-2 md:text-3xl font-bold dark:text-zinc-100 text-zinc-900'>PTE Academic Preparation Online: Tips And Strategy For Success </h3>
    <Swiper
      loop={true}
      spaceBetween={20}
